...
public class SecurityConfig {
    ...
    /**
     * Returns 401 Unauthorized (not 403) when a request reaches a protected endpoint
     * with no valid authentication — e.g. expired or missing JWT.  This lets the
     * frontend distinguish "please re-authenticate" from "you lack the required role".
     */
    @Bean
