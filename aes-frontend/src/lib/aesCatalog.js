 ...
 *
 * Image URLs are referenced live (no local copies). The companion human-
 * readable spec for these mappings is at /aes-content-catalog.txt at the
 * repo root.
 */
...
export const buildingTypeMeta = (value) =>
  BUILDING_TYPES.find((b) => b.value === value);

// ─── Brand partners ────────────────────────────────────────────────────────
export const AES_BRANDS = [
